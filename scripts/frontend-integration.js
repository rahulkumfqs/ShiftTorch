 ...
 * This file demonstrates how to integrate Shifttorch with a web frontend
 */

// For React/Vue/Angular applications
export class ShifttorchClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ShifttorchClient(provider, contractAddress);
